...
public final class KconfigModelImpl implements KconfigModel {
	...
	public KconfigModelImpl(final String factoryId, final String name, final KconfigGraph existingGraph) {
		this.factoryId = Objects.requireNonNull(factoryId);
		this.name = Objects.requireNonNull(name);
		this.graph = existingGraph;
	}

	public KconfigModelImpl(final String factoryId) {
		this(factoryId, DEFAULT_NAME);
	}

	public KconfigModelImpl(final String factoryId, final String name) {
		this.factoryId = Objects.requireNonNull(factoryId);
		this.name = Objects.requireNonNull(name);
	...
	public boolean equals(final Object o) {
		...
		if (!(o instanceof KconfigModelImpl other)) {
			return false;
		}
